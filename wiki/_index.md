...
> 由 AI 自动维护。每次入库后更新。最后更新：2026-06-18
...
- [[Google工程实践-代码审查规范]] — Google 公开的代码审查规范（eng-practices），Reviewer指南+CL作者指南，核心：代码健康度持续改善，小CL原则，LGTM标准，与Karpathy编码准则同构
...
- [[Insight-可视化技能的安全信任链与知识积累的三角关系-2026-06-06]] — Markdown可视化技能 × OpenClaw安全体系 × Karpathy知识库理念，揭示可视化Skill是安全信任链中最易被忽视的环节，wiki maturity机制与SecureClaw巡检是同构的信任积累机制
- [[Insight-理解边界的所有权决定角色跃迁的天花板-2026-06-08]] — Understand-Anything × AI与商业角色转变 × Agent技能-addyosmani，揭示AI时代真正分水岭：不是"会不会用工具"，而是"谁在定义系统理解的边界"
- [[Insight-知识演化的确定性重放与安全可审计性-2026-06-18]] — HyperFrames确定性渲染 × GBrain Compiled Truth+Timeline × 零信任安全，揭示知识污染攻击的无声累积风险，确定性编译过程是知识系统的安全底线
...
- [[Insight-受约束的自主性是复利系统的共同底层-2026-04-30]] — 做梦机制 × Karpathy三层架构 × 零信任安全，三系统共享同一底层原则：Read & Append freely，Modify & Delete carefully，Destroy never unilaterally
- [[Insight-基础设施即行为契约-2026-05-02]] — Coolify自托管 × CLAUDE.md行为声明 × 零信任安全，三层信任工程：物理层信任独立 + 行为层声明式约束 + 运行时拦截，揭示"信任的成本是声明的成本"
- [[Insight-结构优于内容是Agent系统的底层公理-2026-05-04]] — OpenClaw安全体系 × GBrain知识脑 × CCGS游戏工作室，三系统底层公理：结构比内容更稳定，格式/权限/层级约束才是防熵的真正载体
- [[Insight-Skill即幂等知识单元-2026-05-05]] — Skill 的幂等性与知识单元洞见（insights/）
- [[Insight-工具使用者与资产持有者的分野-2026-05-06]] — 效率红利的分配边界洞见（洞见/）
- [[Insight-隐式状态显式化是AI协作纪律的底层范式-2026-05-07]] — Agent 协作隐式状态显式化洞见（insights/）
- [[Insight-配置即知识基因-2026-05-09]] — 配置文件作为知识基因单元的洞见（insights/）
- [[Insight-摩擦消除是迭代速度的乘数-2026-05-10]] — 摩擦消除与迭代速度洞见（洞见/）
- [[Insight-自维护基础设施的认知闭环-2026-05-11]] — Karpathy wiki模式 × Coolify自托管 × 自学习复盘，揭示可持续系统必须内化自身维护能力，三层自主权（基础设施/知识/行为）的闭环架构
- [[Insight-自托管知识基础设施的组织化演进-2026-05-12]] — Coolify × GBrain × CCGS 三层递进：从基础设施到知识到组织的自托管演进，揭示"无供应商锁定"与"复利资产积累"是同一哲学在不同层次的体现
- [[Insight-可验证目标是AI系统的通用认知货币-2026-05-16]] — Karpathy编码准则 × Graphify知识图谱 × 自学习复盘，三层碰撞：AI系统在行为/结构/经验三层的失败共享同一病因，解法是把模糊状态转化为可验证结构
- [[Insight-有状态积累与无状态复现是Agent工具的两极-2026-05-17]] — Codex记忆层 × GBrain × HyperFrames，揭示Agent工具的根本分野：知识层需有状态积累复利，执行层需无状态确定性可复现，混用两极是系统设计的根本失误
- [[Insight-错误驱动进化是系统自愈的最小闭环-2026-05-20]] — 自学习复盘 × Coolify × 超能力技能集，三层联动：工程流程 + 记忆 + 基础设施，每次错误都成为系统不可逆进化的触发信号，揭示自愈系统的最小完整闭环结构
- [[Insight-记忆技能知识库的三重遗忘率均衡-2026-05-21]] — Agent记忆持久化 × OpenClaw-Skill生态 × wiki-compiler，揭示记忆层（衰减型）/技能层（零遗忘）/知识层（主动蒸馏）三种遗忘率设计是认知体系稳定的隐性前提，三层错位是常见设计失误
- [[Insight-Skill生态的主动性进化-2026-05-22]] — OpenClaw-Skill生态 × Agent技能-addyosmani × Wiki与RAG的对比，揭示Skills库与知识库面临同构困境：推荐型主动性无积累（类RAG），自修复型主动性有积累（类Wiki），Skill生态的成熟形态是有机图谱而非安装包集合
- [[Insight-结构沉淀是效率红利的留存条件-2026-06-07]] — GEOFlow知识库先行 × Google代码健康制度 × AI商业角色转变，揭示效率提升本身是一次性的，只有结构性沉淀才能将效率转化为可复利资产
