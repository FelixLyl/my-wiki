...
- 新建：concepts/LLM知识库三层架构.md
- 新建：concepts/做梦机制.md
- 新建：patterns/Wiki-vs-RAG.md
- 新建：patterns/幂等防重模式.md
- 新建：people/Andrej-Karpathy.md
- 新建：sources/karpathy-llm-wiki-pattern.md
- 新建：sources/zhangpelf-wiki-compiler-v2.md
- 新建：sources/farzaa-personal-wiki-skill.md
- 更新：concepts/知识沉淀双轨机制.md（补充知识库编译器视角关联）

## [2026-04-06] dream | 做梦机制 — 灵感碰撞 + 健康检查

- 巡逻：raw/ 无遗漏素材（AI编程.pdf 已入账）
- 新建：insights/Insight-AI系统的三层记忆架构-2026-04-06.md
- 健康检查：孤儿页 1→0（修复），死链 0，超长文章 0，空stub 0
- 更新：_index.md（+1 insights 条目）

## [2026-04-05] ingest | AI编程.pdf — 触及 4 篇文章

- 新建：concepts/Claude-Agent-Teams.md
