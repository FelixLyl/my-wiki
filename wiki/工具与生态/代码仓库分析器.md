...
related: ["[[OpenClaw-Skill生态]]", "[[Claude-Code源码架构]]", "[[Claude子Agent机制]]", "[[Markdown查看器技能]]"]
---
...
第 5 阶段的**并行 Sub-agent 分析**是这个工作流的关键创新——将大型代码库的模块分析并发化，参见 [[Claude子Agent机制]]。
...
repo-analyzer 是 [[OpenClaw-Skill生态]] 中"代码理解"方向的代表性工具，与 [[Markdown查看器技能]]（可视化输出）配合使用效果更佳——repo-analyzer 生成 Mermaid 图，markdown-viewer-skills 提供多引擎渲染。
