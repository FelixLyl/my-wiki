...
related: ["[[个人知识库编译器模式]]", "[[Wiki与RAG的对比]]", "[[CLAUDE-md配置方法论]]", "[[Andrej-Karpathy]]", "[[LLM-Wiki桌面工具]]"]
---
...
[[LLM-Wiki桌面工具]] 在三层架构上新增了 purpose.md，定义知识库的目标、关键问题、研究范围和演进论点。LLM 在每次 ingest 和 query 时读取它，确保行为对准用户意图。
